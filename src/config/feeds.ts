...
const FULL_FEEDS: Record<string, Feed[]> = {
  ...
  us: [
    ...
    { name: 'Washington Post', url: rss('https://feeds.washingtonpost.com/rss/national') },
  ...
  canada: [
    ...
    { name: 'CBC Politics', url: rss('https://www.cbc.ca/cmlink/rss-politics') },
    { name: 'CBC Business', url: rss('https://www.cbc.ca/cmlink/rss-business') },
    { name: 'Globe and Mail', url: rss('https://www.theglobeandmail.com/arc/outboundfeeds/rss/category/canada/') },
    { name: 'National Post', url: rss('https://nationalpost.com/feed') },
    { name: 'Toronto Star', url: rss('https://www.thestar.com/content/thestar/feed.RSSManagerServlet.articles.topstories.rss') },
    { name: 'CTV News', url: rss('https://www.ctvnews.ca/rss/ctvnews-ca-top-stories-public-rss-1.822009') },
    { name: 'CBC Nova Scotia', url: rss('https://www.cbc.ca/cmlink/rss-canada-novascotia') },
    { name: 'SaltWire NS', url: rss('https://www.saltwire.com/rss/news/') },
    { name: 'Canada.ca Health', url: rss('https://www.canada.ca/en/public-health/news/notices.atom') },
    { name: 'Environment Canada NS', url: rss('https://weather.gc.ca/rss/warning/ns_e.xml') },
    { name: 'Bank of Canada', url: rss('https://www.bankofcanada.ca/feed/') },
    { name: 'StatCan News', url: rss('https://www150.statcan.gc.ca/n1/dai-quo/feeds/daily-quotidien_ENG.xml') },
    { name: 'RCMP News', url: rss('https://www.rcmp-grc.gc.ca/en/feed-flux/news-nouvelles') },
    { name: 'NS EMO', url: rss('https://novascotia.ca/rss/emo.rss') },
    { name: 'HRP News', url: rss('https://news.google.com/rss/search?q=Halifax+Regional+Police&hl=en-CA&gl=CA&ceid=CA:en') },
    { name: 'Halifax Fire', url: rss('https://news.google.com/rss/search?q=Halifax+Regional+Fire&hl=en-CA&gl=CA&ceid=CA:en') },
    { name: 'CityNews Halifax', url: rss('https://halifax.citynews.ca/feed') },
    { name: 'NS Wildfires', url: rss('https://news.google.com/rss/search?q=Nova+Scotia+wildfire&hl=en-CA&gl=CA&ceid=CA:en') },
    ...
    { name: 'Canadian Press', url: rss('https://news.google.com/rss/search?q=source:thecanadianpress.com&hl=en-CA&gl=CA&ceid=CA:en') },
    { name: 'Macleans', url: rss('https://www.macleans.ca/feed/') },
    { name: 'The Narwhal', url: rss('https://thenarwhal.ca/feed/') },
    { name: 'Haligonia', url: rss('https://haligonia.ca/feed/') },
    { name: 'Chronicle Herald', url: rss('https://www.thechronicleherald.ca/feed/') },
    { name: 'Atlantic Business', url: rss('https://atlanticbusinessmagazine.net/feed/') },
    { name: 'NS Government', url: rss('https://news.novascotia.ca/en/rss.xml') },
    { name: 'Transport Canada', url: rss('https://tc.canada.ca/en/corporate-services/news.rss') },
    { name: 'Canadian Coast Guard', url: rss('https://news.google.com/rss/search?q=Canadian+Coast+Guard&hl=en-CA&gl=CA&ceid=CA:en') },
  ],
  europe: [
    {
      name: 'France 24',
  ...
  gov: [
    ...
    { name: 'NOAA Storms', url: rss('https://www.nhc.noaa.gov/rss_examples/index-at.xml') },
    { name: 'USGS Earthquakes', url: rss('https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/2.5_day.atom') },
    { name: 'US Coast Guard', url: rss('https://news.google.com/rss/search?q="US+Coast+Guard"&hl=en-US&gl=US&ceid=US:en') },
    { name: 'FAA Alerts', url: rss('https://news.google.com/rss/search?q=FAA+aviation+alert+NOTAM&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Lawfare', url: rss('https://www.lawfaremedia.org/rss.xml') },
  ],
  layoffs: [
  ...
  climate: [
    ...
    { name: 'NOAA Climate', url: rss('https://news.google.com/rss/search?q=NOAA+climate+weather+hurricane&hl=en-US&gl=US&ceid=US:en') },
    { name: 'Met Office', url: rss('https://www.metoffice.gov.uk/about-us/news-and-media/media-centre/news/rss.xml') },
    { name: 'NASA Earth', url: rss('https://www.nasa.gov/rss/dyn/earth.rss') },
  ],
  maritime: [
    { name: 'Maritime Executive', url: rss('https://maritime-executive.com/rss') },
    { name: 'Splash247', url: rss('https://splash247.com/feed/') },
    { name: 'Port Technology', url: rss('https://www.porttechnology.org/news/feed/') },
  ],
  security: [
    { name: 'Lawfare', url: rss('https://www.lawfaremedia.org/rss.xml') },
    { name: 'Just Security', url: rss('https://www.justsecurity.org/feed/') },
    { name: 'C4ISRNET', url: rss('https://www.c4isrnet.com/arc/outboundfeeds/rss/') },
    { name: 'ACLED', url: rss('https://news.google.com/rss/search?q=ACLED+armed+conflict+event&hl=en-US&gl=US&ceid=US:en') },
  ],
  health_global: [
    { name: 'Outbreak News', url: rss('https://outbreaknewstoday.com/feed/') },
    { name: 'STAT News', url: rss('https://www.statnews.com/feed/') },
    { name: 'Health Canada', url: rss('https://news.google.com/rss/search?q="Health+Canada"+advisory+recall&hl=en-CA&gl=CA&ceid=CA:en') },
    { name: 'Lancet', url: rss('https://www.thelancet.com/rssfeed/lancet_online.xml') },
  ],
};
